...
Batch normalization is a crucial element to the convergence and robustness of many deep learning applications; however, its implementation must be carefully address for complex-valued data. 
...
For other complex-valued normalization methods, see :doc:`layernorm <./layernorm>`. 
